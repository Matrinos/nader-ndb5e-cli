...
func (d *MetricalData) ToSenML(baseML BaseSenML) ([]byte, error) {
	...
	result = append(result, SenML{N: "BVoltage", V: float32(d.BVoltage) * 0.01, U: "V"})
	result = append(result, SenML{N: "CVoltage", V: float32(d.CVoltage) * 0.01, U: "V"})
	result = append(result, SenML{N: "ABVoltage", V: float32(d.ABVoltage) * 0.1, U: "V"})
	result = append(result, SenML{N: "BCVoltage", V: float32(d.BCVoltage) * 0.1, U: "V"})
	result = append(result, SenML{N: "CAVoltage", V: float32(d.CAVoltage) * 0.1, U: "V"})
	result = append(result, SenML{N: "AFrequency", V: float32(d.AFrequency) * 0.1, U: "Hz"})
	result = append(result, SenML{N: "BFrequency", V: float32(d.BFrequency) * 0.1, U: "Hz"})
	result = append(result, SenML{N: "CFrequency", V: float32(d.CFrequency) * 0.1, U: "Hz"})
	result = append(result, SenML{N: "PhaseState", V: float32(d.PhaseState)})
	result = append(result, SenML{N: "AActiveEnergy", V: float32(d.ARealPower) * 0.1, U: "kW"})
	result = append(result, SenML{N: "BRealPower", V: float32(d.BRealPower) * 0.1, U: "kW"})
	result = append(result, SenML{N: "CRealPower", V: float32(d.CRealPower) * 0.1, U: "kW"})
	result = append(result, SenML{N: "RealPowerTotal", V: float32(d.RealPowerTotal) * 0.1, U: "kW"})
	result = append(result, SenML{N: "AReactivePower", V: float32(d.AReactivePower) * 0.1, U: "kVar"})
	result = append(result, SenML{N: "BReactivePower", V: float32(d.BReactivePower) * 0.1, U: "kVar"})
	result = append(result, SenML{N: "CReactivePower", V: float32(d.CReactivePower) * 0.1, U: "kVar"})
	result = append(result, SenML{N: "ReactivePowerTotal", V: float32(d.ReactivePowerTotal) * 0.1, U: "kVar"})
	result = append(result, SenML{N: "AReactivePower", V: float32(d.AApparentPower) * 0.1, U: "kVA"})
	result = append(result, SenML{N: "BApparentPower", V: float32(d.BApparentPower) * 0.1, U: "kVA"})
	result = append(result, SenML{N: "CApparentPower", V: float32(d.CApparentPower) * 0.1, U: "kVA"})
	result = append(result, SenML{N: "ApparentPowerTotal", V: float32(d.ApparentPowerTotal) * 0.1, U: "kVA"})
	result = append(result, SenML{N: "TotalUsagePower", V: float32(d.TotalUsagePower) * 0.1, U: "kW"})
	result = append(result, SenML{N: "APowerFactor", V: float32(d.APowerFactor) * 0.01})
	result = append(result, SenML{N: "BPowerFactor", V: float32(d.BPowerFactor) * 0.01})
	result = append(result, SenML{N: "CPowerFactor", V: float32(d.CPowerFactor) * 0.01})
	result = append(result, SenML{N: "TotalPowerFactor", V: float32(d.TotalPowerFactor) * 0.01})
	result = append(result, SenML{N: "AActiveEnergy", V: float32(d.AActiveEnergy) * 0.1, U: "kWh"})
	result = append(result, SenML{N: "BActiveEnergy", V: float32(d.BActiveEnergy) * 0.1, U: "kWh"})
	result = append(result, SenML{N: "CActiveEnergy", V: float32(d.CActiveEnergy) * 0.1, U: "kWh"})
	result = append(result, SenML{N: "ActiveEnergyTotal", V: float32(d.ActiveEnergyTotal) * 0.1, U: "kWh"})
	result = append(result, SenML{N: "AReactiveEnergy", V: float32(d.AReactiveEnergy) * 0.1, U: "kVarh"})
	result = append(result, SenML{N: "BReactiveEnergy", V: float32(d.BReactiveEnergy) * 0.1, U: "kVarh"})
	result = append(result, SenML{N: "CReactiveEnergy", V: float32(d.CReactiveEnergy) * 0.1, U: "kVarh"})
	result = append(result, SenML{N: "ReactiveEnergyTotal", V: float32(d.ReactiveEnergyTotal) * 0.1, U: "kVarh"})
	result = append(result, SenML{N: "AApparentEnergy", V: float32(d.AApparentEnergy) * 0.1, U: "kVAh"})
	result = append(result, SenML{N: "BApparentEnergy", V: float32(d.BApparentEnergy) * 0.1, U: "kVAh"})
	result = append(result, SenML{N: "CApparentEnergy", V: float32(d.CApparentEnergy) * 0.1, U: "kVAh"})
	result = append(result, SenML{N: "ApparentEnergyTotal", V: float32(d.ApparentEnergyTotal) * 0.1, U: "kVAh"})
	result = append(result, SenML{N: "Temperature", V: float32(d.Temperature) * 0.1, U: "C"})
	result = append(result, SenML{N: "LeakageCurrent", V: float32(d.LeakageCurrent) * 0.1, U: "mA"})
